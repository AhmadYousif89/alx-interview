...
print(
    validUTF8([0b11110000, 0b10000010, 0b10000010, 0b10000010])
)  # Four byte character
...
print(
    validUTF8([0b11110000, 0b10000010, 0b10000010])
)  # Missing continuation byte
print(
    validUTF8([0b11000010, 0b11000010])
)  # Continuation byte does not start with 10
print(
    validUTF8([0b11100010, 0b11000010, 0b10000010])
)  # Continuation byte does not start with 10
print(
    validUTF8([0b11110000, 0b11000010, 0b10000010, 0b10000010])
)  # Continuation byte does not start with 10
